...
export default function AddNewAddress({ addresses, setAddressId }: Props) {
  ...
  const filteredSubDistrcts = useMemo(() => {
    return subdistricts.upazilas.filter(
  ...
  const filteredCities = useMemo(() => {
    return cities.cities.filter(
      (city) => city.subdiscrict_id === subDistrictId,
    );
  }, [subDistrictId]);
      ...
      <View style={styles.formContainer}>
        ...
        <View style={{ gap: 16, marginTop: 24 }}>
          <View>
            ...
            <TextInput
              ...
              style={[
                styles.inputField,
                errors.name && { borderColor: "#b90e0e" },
              ]}
            />
            {errors.name ? (
          ...
          <View>
            ...
            <TextInput
              ...
              style={[
                styles.inputField,
                errors.mobile && { borderColor: "#b90e0e" },
              ]}
            />
            {errors.mobile ? (
          ...
          >
            <View style={{ width: "48%" }}>
              ...
              <View
                style={[
                  ...
                  errors.district && { borderColor: "#b90e0e" },
                ]}
              >
                <Picker
            ...
            <View style={{ width: "48%" }}>
              ...
              <View
                style={[
                  styles.pickerContainer,
                  errors.subDistrict && { borderColor: "#b90e0e" },
                ]}
              >
                <Picker
                  ...
                  onValueChange={(value) => {
                    ...
                    const subDistrict = filteredSubDistrcts.find(
                      (s) => s.id === value,
                    );
                ...
                >
                  <Picker.Item label="Select" value="" color="#ADADAD" />
                  {filteredSubDistrcts.map((subDis) => (
                    <Picker.Item
                      key={subDis.id}
                      label={`${subDis.name}`}
                      value={subDis.id}
          ...
          <View>
            ...
            <TextInput
              ...
              style={[
                styles.inputField,
                errors.address && { borderColor: "#b90e0e" },
              ]}
            />
            {errors.address ? (
          ...
          <View>
            <Text style={styles.inputTitle}>
              Email<Text style={{ color: "#ADADAD" }}> (optional)</Text>
            </Text>
            <TextInput
              value={email}
              placeholder="@email"
          ...
          <View>
            <Text style={styles.inputTitle}>
              Order Notes<Text style={{ color: "#ADADAD" }}> (optional)</Text>
            </Text>
            <TextInput
              value={orderNote}
              multiline={true}
              ...
              style={[
                styles.inputField,
                { height: 90, borderRadius: 20, textAlignVertical: "top" },
              ]}
            />
          </View>
        </View>
        ...
        >
          ...
          >
            ...
            ></Image>
            <Text style={{ color: "#ADADAD", fontSize: 14, fontWeight: "400" }}>
              Add tag
            </Text>
          </Pressable>
          <FlatList
            ...
            renderItem={({ item, index }) => {
              ...
              if (alreadyTaken) {
                return (
                  <Pressable style={styles.tagListContainer}>
                    <View
                      style={[
                        {
                          borderWidth: 2,
                ...
                return (
                  ...
                  >
                    ...
                    >
                      {isSelected && <View style={styles.radioButton}></View>}
                    </View>
                    <Text
                      style={{
                        color: isSelected ? "" : "#575757",
                        fontSize: 14,
                        fontWeight: "400",
                      }}
                    >
        ...
        <Pressable disabled={loading} onPress={() => getNewAddress()}>
          <PrimaryButton label={loading ? "Saving..." : "Save"}></PrimaryButton>
        </Pressable>
      </View>
    </ScrollView>
  );
