    ...
    <>
      <View style={{ paddingHorizontal: 20 }}>
        <View style={styles.header}>
          <Header page="changepassword" isModal onClose={onClose} />
        </View>
        ...
        >
          <Text style={styles.descriptionText}>
            Update your account password securely to protect your restaurant
            profile, orders, payment methods, and personal information.
          </Text>
