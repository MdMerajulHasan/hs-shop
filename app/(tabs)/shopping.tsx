            ...
            <View style={styles.footerContainer}>
              <View style={styles.voucherContainer}>
                <View style={styles.voucherItem}>
                  ...
                  <Text style={styles.voucherItemText}>
                    ${totalPrice.toFixed(2)}
                  </Text>
                </View>
                <View style={styles.voucherItem}>
                  <Text style={styles.voucherItemText}>Delivery Charge</Text>
                  <Text style={[styles.voucherItemText, { color: "#FE6568" }]}>
                ...
                <View style={styles.voucherItem}>
                  ...
                  <Text style={[styles.voucherItemText, { color: "#06A316" }]}>
                    -${discount.toFixed(2)}
                  </Text>
                </View>
                <View style={styles.voucherItem}>
                ...
                <View style={styles.voucherItem}>
                  ...
                  <Text style={[styles.voucherItemText2]}>
      ...
      >
        <View style={{ paddingHorizontal: 10 }}>
          <View style={[styles.voucherItem, { paddingVertical: 20 }]}>
            ...
            <Text style={[styles.voucherItemText3]}>
              ${totalAmount.toFixed(2)}
            </Text>
          </View>
          <Pressable
          ...
          >
            <PrimaryButton
              label={loading ? "Order Placing..." : "Place Order"}
            ></PrimaryButton>
          </Pressable>
        </View>
      </View>
