      ...
      .map((item) => {
        ...
        const commonIngredients = item.ingredients.filter((ingredient) =>
          product.ingredients.some(
            (p) => p?.toLowerCase() === ingredient?.toLowerCase(),
          ),
        );
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.card}>
          ...
          >
              ...
              {product.sizes.map((s) => (
                ...
                >
                  <Text
                    style={[
                      styles.sizeText,
                      selectedSize?.id === s.id && styles.activeSizeText,
                    ]}
                  >
                    {s.label}
                  </Text>
            ...
            <View style={styles.row}>
              <Text
                style={{ fontSize: 14, fontWeight: "500", color: "#272727" }}
              >
                SKU: {product.sku}
              </Text>
              {product.stock ? (
          ...
          <View style={styles.shippingContainer}>
            <View style={{ width: "49%" }}>
              ...
              <View>
                <Text style={styles.shippingCardTitle}>
                  Shipping & Returns:
                </Text>
                <Text style={styles.shippingText}>
                  Available on all orders over ${RESTAURANT.minimumOrder}
                </Text>
              </View>
            </View>
            <View style={{ width: "49%" }}>
              <View style={styles.shippingIcon}>
                <Image
                  ...
                  style={{ width: 18, height: 18, tintColor: "#F5F5F5" }}
                />
              </View>
          ...
          {productReview.length ? (
            ...
            >
              <Text style={[styles.section, { marginBottom: 0 }]}>
                Client Feedback
              </Text>
            </View>
          ) : null}
          ...
          {similarItems.length > 0 ? (
            ...
            <View style={{ paddingTop: 1, marginTop: 19 }}></View>
          )}
        </View>
      </ScrollView>
      {/* BOTTOM BAR */}
      <View style={styles.bottom}>
        ...
        >
          <View style={styles.qtyBox}>
            ...
            <Text style={{ fontSize: 20, fontWeight: "600", color: "#272727" }}>
              {qty}
            </Text>
        ...
        <View style={styles.actions}>
          ...
          >
            <Image
              ...
              tintColor={"#F5F5F5"}
            ></Image>
            <Text style={{ color: "#F5F5F5", fontSize: 16, fontWeight: "500" }}>
              Add To Cart
            </Text>
          </Pressable>
